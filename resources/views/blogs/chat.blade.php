...
url('https://images.wallpaperscraft.com/image/single/beige_blur_light_95712_1920x1080.jpg');
    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="/note/check-all">Мои проекты</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link active" href="/chat/{id}">События и чаты</a>
                </li>
            </ul>
